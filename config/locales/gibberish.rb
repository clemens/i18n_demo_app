I18n.backend.store_translations :'gibberish', {
  ...
  :date => {
    ...
    :day_names => [nil] + %w(Sunday-ish Monday-ish Tuesday-ish Wednesday-ish Thursday-ish Friday-ish Saturday-ish),
    :abbr_day_names => [nil] + %w(Sun-i Mon-i Tue-i Wed-i Thu-i Fri-i Sat-i),
